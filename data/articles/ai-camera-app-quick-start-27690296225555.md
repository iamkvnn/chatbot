...
Updated At: 2026-06-29T19:26:02Z
...
This feature is supported on [Linux](/hc/en-us/articles/360034379573-Linux), [Windows](/hc/en-us/articles/360034379293-Windows), and [Android Device](/hc/en-us/articles/1500004585601-OptiSigns-Pre-Configured-Android-Device).
...
[![](/hc/article_attachments/27855243843091)](/hc/article_attachments/27855243843091)

2. Review the data collected by the app on the portal's reporting page.

Ex:

![Screenshot 2024-03-22 141025.png](/hc/article_attachments/27696211826835)

From there, you can modify the set-up to fit your needs.

**1.) Preparation:**

If you haven't paired a device yet, follow this guide [for Windows](/hc/en-us/articles/360034379293-Windows), or this guide [for Linux](/hc/en-us/articles/360034379573) or [Raspberry Pi](/hc/en-us/articles/360034379693) to install and run OptiSigns Digital Signage Player first.
...
**![annotely_image (19).jpeg](/hc/article_attachments/27690296203923)**

Click New App on the top right corner:

**![annotely_image (20).jpeg](/hc/article_attachments/27690263765011)**

First, click the "**AI Camera**" tab on the left side. Then, click the "**Build**" button in the bottom right corner.

**![annotely_image (21).jpeg](/hc/article_attachments/27690263766035)**

You will then be directed to the AI Camera Build page.

![Screenshot 2024-03-22 101159.png](/hc/article_attachments/27690263767315)

![Screenshot 2024-03-22 101449.png](/hc/article_attachments/27690296216979)
...
![Screenshot 2024-03-28 112724.png](/hc/article_attachments/27882861309971)
...
![annotely_image (22).jpeg](/hc/article_attachments/27696211732627)

3. Click **More**.

![](/hc/article_attachments/27974903303571)

4.  **Activate** the AI Add-on.

![](/hc/article_attachments/27974903309715)

If you want the device to send data for Analytics purposes, please leave the Send AI Data box checked as well. You can learn more about what data we collect [here](/hc/en-us/articles/360058259834-OptiSigns-AI-Camera-FAQs).

![](/hc/article_attachments/27974888673171)

5. Change the **AI Add-on** and it will bring you to the select Asset Page.

6. Click **Engage**

![annotely_image (25).jpeg](/hc/article_attachments/27696232098195)

7. Choose your **AI App** and then save.

![annotely_image (26).jpeg](/hc/article_attachments/27696211793555)

**4**.) **Set up camera & app on your device**

If you are using Linux or Raspberry Pi, the AI Camera will be automatically install when you click AI Camera Activate in the step above. You may need to restart your device. If you need instruction on how to manually activate, run AI Camera for Linux, you can follow [this guide](/hc/en-us/articles/360060676993-How-to-manually-install-activate-OptiSigns-AI-Add-on-on-Linux-or-Raspberry-Pi).

For Android, you'll need to go to the app permission settings and grant camera access.

If you are using Windows just download & run [optisigns-ai-detection.exe.](https://links.optisigns.com/ai-add-on-win) If you want OptiSigns AI Detection to run on system start up just follow these [steps here](/hc/en-us/articles/360058345334-How-to-run-OptiSigns-AI-Add-on-on-start-up-in-Windows).

The app will log events it detected like below.

[![](/hc/article_attachments/27805047501843)](/hc/article_attachments/27805047501843)
