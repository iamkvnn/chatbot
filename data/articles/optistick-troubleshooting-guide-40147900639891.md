...
If you’ve got an OptiStick Player and you’re having issues, you’ve come to the right place. For first time setup, see our article on how to [Set Up the OptiStick Player](/hc/en-us/articles/27267311796243-OptiSigns-OptiStick-Digital-Signage-Player).
...
![android player comparison gen2 vs gen3](/hc/article_attachments/40147900608403)
...
By default, an OptiStick Player has an [**Operational Schedule**](/hc/en-us/articles/28598173096723-How-To-Create-and-Use-Operational-Schedules-HDMI-CEC-RS-232) built in to ensure it has 8 hours of downtime per day:

![operational schedule image](/hc/article_attachments/40147917435923)
...
![open troubleshooting page optisigns app](/hc/article_attachments/40147917438355)

Now you can view detailed information about the app’s status and connectivity to assist with troubleshooting.

![troubleshooting page optisigns](/hc/article_attachments/40147917440787)
...
- **Check Connection to API Services**: Tests the device's connection to OptiSigns services.
  - **Note**: If this check fails, it may be due to a firewall blocking the connection. Refer to our [**Whitelist Article**](/hc/en-us/articles/360047275934) for the required URLs and ports.
...
![exit optisigns app](/hc/article_attachments/40147917441555)
...
![access network optisigns player](/hc/article_attachments/40147900613907)
...
**![gen 3 remote control](/hc/article_attachments/40147917443347)**
...
![gen 2 remote control](/hc/article_attachments/40147900615827)
...
- Check your firewall settings, and ensure you’ve [**Whitelisted OptiSigns IP addresses and ports**](/hc/en-us/articles/360047275934-Whitelist-OptiSigns-IP-addresses-ports).
...
![settings menu](/hc/article_attachments/41497198237971)

Select **Device Preferences**.

![device preferences option android side menu](/hc/article_attachments/41497175224851)

Select **Date & Time**.

![date & time option android side menu](/hc/article_attachments/41497198242323)

Select **Set time zone**.

![select time zone option android side menu](/hc/article_attachments/41497198243347)
...
![time zone options android](/hc/article_attachments/41497198244627)
...
![factory reset settings](/hc/article_attachments/40147900617363)
...
![optisigns gen 3 player hard reset hole](/hc/article_attachments/40147900618259)
...
![boot mode wipe data option](/hc/article_attachments/40147900620563)

Then choose **Factory data reset:**

**![boot mode factory data reset option](/hc/article_attachments/40147917447443)**
...
![boot mode reboot system now option](/hc/article_attachments/40147917449235)
...
- [**Gen 3 Device Scaling**](/hc/en-us/articles/28026588373139-How-to-Fix-The-Scaling-Issue-on-OptiSigns-Android-Device-Gen-3)
- [**Gen 2 Device Scaling**](/hc/en-us/articles/27607906766483-How-to-Fix-The-Scaling-Issue-on-OptiSigns-Android-Device)

### Designer or Template Sizing Issues

If using the [**Designer app**](/hc/en-us/articles/4404151402899-How-to-use-OptiSigns-Template-Designer-app-to-make-your-Digital-Signs-in-minutes)**,** try setting the canvas size to 960x540, or change the display size on Android.
